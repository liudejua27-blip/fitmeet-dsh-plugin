 ...
 */
export declare function startConnection(ctx: Context, config: ResolvedConfig, policy: ResolvedReconnectPolicy, oauth: OAuthRuntime, reporter: ConnectionReporter): ConnectionHandle;
